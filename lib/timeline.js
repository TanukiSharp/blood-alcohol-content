...
class Timeline {
    ...
    draw(now, lifetimeDrinks) {
        ...
        for (const lifetimeDrink of lifetimeDrinks) {
            this._drawDrink(lifetimeDrink.startedAt, lifetimeDrink.endsAt, String(lifetimeDrink.index + 1));
        }
        ...
        for (const lifetimeDrink of lifetimeDrinks) {
            this._drawDrink(lifetimeDrink.virtualStartedAt, lifetimeDrink.virtualEndsAt, String(lifetimeDrink.index + 1), lifetimeDrink.isEffective ? 'red' : undefined);
        }
